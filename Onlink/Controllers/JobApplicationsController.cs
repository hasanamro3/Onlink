...
namespace Onlink.Controllers
{
    public class JobApplicationsController : Controller
    {
        ...
        {
            var dataContext = _context.JobApplication.Include(j => j.Job);
        ...
        {
            ViewData["JobId"] = new SelectList(_context.Job, "JobId", "JobName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("JobApplicationId,JobId")] JobApplication jobApplication)
        {
            ...
            ViewData["JobId"] = new SelectList(_context.Job, "JobId", "JobName", jobApplication.JobId);
            return View(jobApplication);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("JobApplicationId,JobId")] JobApplication jobApplication)
        {
